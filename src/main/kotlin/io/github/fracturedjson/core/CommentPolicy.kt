 ...
 *
 * According to the JSON standard, comments aren't allowed. But "JSON with comments" is
 * pretty wide-spread these days, thanks largely to Microsoft, so it's nice to have options.
 */
